...
<div id="wrapper">
    ...
    <nav id="sidebar" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget-password' ? false : true">
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="employee" class="collapse" aria-labelledby="headingemployee" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <router-link class="collapse-item" :to="{name: 'CreateEmployee'}">Add Employee</router-link>
                        <router-link class="collapse-item" :to="{name: 'AllEmployee'}">All Employee</router-link>
                    </div>
                </div>
            </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            <!-- TopBar -->
            <nav id="topBar" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget-password' ? false : true" class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false">
                            ...
                            <router-link class="ml-2 d-none d-lg-inline text-white small" :to="{name: 'Logout'}">
                                Logout
                            </router-link>
                        </a>
