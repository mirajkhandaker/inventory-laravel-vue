                                    ...
                                    <form class="user" @submit.prevent="employeeInsert" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-1">
                                                    <img :src="form.photo" alt="Image Upload">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <router-link class="btn btn-warning" :to="{name: 'AllEmployee'}">All Employee</router-link>
                                        </div>
                                    </form>
                                </div>
                            </div>
    ...
    data(){
        return {
            form:{
                ...
                joining_date:null,
                nid:null,
                photo:'https://image.flaticon.com/icons/png/128/725/725008.png'
            },
            errors:{}
        }
    },
