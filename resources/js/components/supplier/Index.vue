            ...
            <div class="col-lg-12 mb-4">
                ...
                <div class="card">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <router-link class="btn btn-primary bg-gradient-primary" :to="{name: 'CreateSupplier'}">Add Supplier</router-link>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                            <tr v-for="supplier in suppliers.data" :key="supplier.id" v-if="!loading">
                                <td>{{supplier.id}}</td>
                                <td>
                    ...
                    <div class="card-footer">
                        <pagination :limit="2" :show-disabled="true" align="center" :data="suppliers" @pagination-change-page="allSupplier">
